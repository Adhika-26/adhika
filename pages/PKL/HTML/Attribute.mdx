...
Memasukan gambar dari hosting eksternal/tidak dalam local, seperti:
```
...
```
### `id` Attribute
id berfungsi untuk menentukan id unik untuk elemen HTML, dapat digunakan untuk menunjuk deklarasi style tertentu dalam style sheet dan
juga digunakan untuk mengakses dan memanipulasi elemen dengan id tertentu di Javascript.
```
<html>
...
- Pengiriman formulir dengan POST tidak dapat di-bookmar
